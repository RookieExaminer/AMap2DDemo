...
import com.amap.map2d.demo.overlay.CustomMarkerWindowActivity;
...
//----------------------------------------------------------------------------------------------------------------------------------------
            ...
            //自定义 Marker 、Window
            new DemoDetails(R.string.custommarkerwindow_demo, R.string.custommarkerwindow_demo, CustomMarkerWindowActivity.class),
